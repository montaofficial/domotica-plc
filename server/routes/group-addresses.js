...
const createGroupAddressSchema = z.object({
  ...
  device_type: z.enum(['light', 'switch', 'pulse', 'fan', 'door', 'blind', 'sensor', 'thermostat', 'other']).default('switch'),
...
const updateGroupAddressSchema = z.object({
  ...
  description: z.string().max(500).optional(),
  device_type: z.enum(['light', 'switch', 'pulse', 'fan', 'door', 'blind', 'sensor', 'thermostat', 'other']).optional(),
